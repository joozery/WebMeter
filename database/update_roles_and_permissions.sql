-- Update Roles and Create Permissions System
-- อัปเดต roles และสร้างระบบ permissions
...
-- Super Admin (id=5) gets all permissions
INSERT INTO role_permissions (role_id, permission_id)
SELECT 5, id FROM permissions;

-- Admin (id=1) gets most permissions except system settings admin
INSERT INTO role_permissions (role_id, permission_id)
SELECT 1, id FROM permissions 
WHERE module != 'settings' OR action != 'admin';

-- Manager (id=6) gets read permissions and some write permissions
INSERT INTO role_permissions (role_id, permission_id)
...
-- Supervisor (id=2) gets read permissions and data management
INSERT INTO role_permissions (role_id, permission_id)
...
-- Engineer (id=7) gets read permissions and data management
INSERT INTO role_permissions (role_id, permission_id)
...
-- Operator (id=3) gets read permissions and some write permissions
INSERT INTO role_permissions (role_id, permission_id)
SELECT 3, id FROM permissions 
WHERE action IN ('read') 
   OR (module = 'data' AND action = 'export');

-- Viewer (id=4) gets only read permissions
INSERT INTO role_permissions (role_id, permission_id)
