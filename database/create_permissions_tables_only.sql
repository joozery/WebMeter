-- Create Permissions System Tables (Only missing tables)
-- สร้างตารางสำหรับระบบสิทธิ์การใช้งาน (เฉพาะตารางที่ยังไม่มี)
...
-- 2. Create role_permissions table (many-to-many relationship)
...
-- 3. Create user_roles table (many-to-many relationship)
